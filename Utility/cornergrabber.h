...
public:
    explicit CornerGrabber(QGraphicsItem *parent = 0,  int corner = 0, const qreal grabberSize = 0);
...
private:
    ...
    virtual void hoverMoveEvent ( QGraphicsSceneHoverEvent * event ); ///< must be re-implemented to handle mouse hover enter events
