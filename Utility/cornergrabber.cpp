...
CornerGrabber::CornerGrabber(QGraphicsItem *parent,  int corner, const qreal grabberSize) :
...
{
    _outterborderColor = Qt::black;
    _outterborderColor.setAlpha(100);
    this->update(0,0,_width,_height);
}

void CornerGrabber::hoverMoveEvent(QGraphicsSceneHoverEvent * )
{
